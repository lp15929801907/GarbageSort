...
class Manager(models.Model):  # 管理员信息表
    ...
    manager_stack = models.CharField(max_length=20)  # 管理垃圾桶回收点
...
class Dump(models.Model):  # 垃圾桶信息表
    dump_id = models.CharField(max_length=20, primary_key=True)  # 垃圾桶编号 主键
    dump_name = models.CharField(max_length=20)  # 垃圾桶名称
    dump_number = models.IntegerField()  # 垃圾桶总投放次数
    dump_rest = models.IntegerField()  # 可投放次数
    dump_place = models.CharField(max_length=20)  # 所属垃圾回收点
...
class Throw(models.Model):  # 垃圾投放记录表
    ...
    dump_id = models.CharField(max_length=20)  # 垃圾桶编号
    dump_place = models.CharField(max_length=20)  # 所属垃圾回收点
    dump_type = models.ForeignKey(Type, on_delete=models.CASCADE)  # 垃圾桶类型
